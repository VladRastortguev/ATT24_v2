...
const CreateTex:FC = () => {
  ...
  function resetTaskType(tasktype:string) {
      switch (tasktype){
          ...
          case 'Настройки не зависящие от нас':
              return (
                  <>
                      <option value=""></option>
          ...
          case 'Обслуживание не зависящее от нас':
              return (
                  <>
                      <option value=""></option>
                    ...
                    <div className='VR_taskType_FlexLine'>
                        <div className='VR_taskType_type'>
                            ...
                            <Form.Select 
                                ...
                                <option value="Настройки не зависящие от нас">Настройки не зависящие от нас</option>
                                <option value="Обслуживание">Обслуживание</option>
                                <option value="Обслуживание не зависящее от нас">Обслуживание не зависящее от нас</option>
